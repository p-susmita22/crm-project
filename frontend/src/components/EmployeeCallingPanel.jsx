...
const EmployeeCallingPanel = () => {
  ...
  const displayedCustomers = customers.filter(c => {
    ...
    if (filterType === 'Interested') return c.status === 'Agree';
    if (filterType === 'Rejected') return c.status === 'Reject';
    if (filterType === 'Completed') return c.status !== 'Pending';
    return true;
  });
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div 
            ...
            className={`cursor-pointer text-center rounded-xl px-4 py-2 shadow-sm transition-all border ${filterType === 'all' ? 'ring-2 ring-primary border-primary bg-primary/10 dark:bg-primary/20' : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700'}`} 
            title="Today's calls assigned from Excel"
          >
          ...
          <div 
            ...
            className={`cursor-pointer text-center rounded-xl px-4 py-2 transition-all border ${filterType === 'Interested' ? 'ring-2 ring-green-500 bg-green-100 border-green-500 dark:bg-green-900/40' : 'bg-green-50 border-green-100 dark:bg-green-900/20 dark:border-green-700'}`}
          >
          ...
          <div 
            ...
            className={`cursor-pointer text-center rounded-xl px-4 py-2 transition-all border ${filterType === 'Rejected' ? 'ring-2 ring-red-500 bg-red-100 border-red-500 dark:bg-red-900/40' : 'bg-red-50 border-red-100 dark:bg-red-900/20 dark:border-red-700'}`}
          >
          ...
          <div 
            ...
            className={`cursor-pointer text-center rounded-xl px-4 py-2 transition-all border ${filterType === 'Completed' ? 'ring-2 ring-blue-500 bg-blue-100 border-blue-500 dark:bg-blue-900/40' : 'bg-blue-50 border-blue-100 dark:bg-blue-900/20 dark:border-blue-700'}`}
          >
